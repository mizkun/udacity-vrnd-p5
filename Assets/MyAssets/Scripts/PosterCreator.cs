...
public class PosterCreator : MonoBehaviour {
	...
	public PosterHandlers posterHandlers;


	void Start () {
		//JsonHelper.FromJson<PosterHandlers> (sample_json); 
		CreatePoster ("AAA", "description001", "poster_image_001");
		CreatePoster ("BBB", "description002", "poster_image_003");
		CreatePoster ("CCC", "description003", "poster_image_001");
	}
	...
	void CreatePoster (string title, string description, string image_name) {
		GameObject newPoster = Instantiate (Poster);
